...
@Autonomous(name="BasicAutoRightGoal", group="Robot")
public class  BasicAutoRightGoal extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED,  -45,  -45, 5.0);  // S1: Forward 55 Inches with 5 Sec timeout
